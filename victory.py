...
def lose():
    ...
    lose_win.setText('Нет, оказывается, это Бурж Халифа')
    lose_win.exec_()
def victory():
...
question = QLabel('Какое самый высокий небоскреб в мире?')
but1 = QRadioButton('Бурж Халифа')
but2 = QRadioButton('Москва сити')
but3 = QRadioButton('Шанхайская башня')
but4 = QRadioButton('Ничего из этого')
layout1 = QHBoxLayout()
layout2 = QHBoxLayout()
layout3 = QHBoxLayout()
layout4 = QVBoxLayout()
